...
driver.find_element(By.CLASS_NAME, "emp").click()
time.sleep(3)
driver.find_element(By.CLASS_NAME, "emp_new").click()

name_field11 = driver.find_element(By.CLASS_NAME, "empname")
name_field11.click()
name_field11.send_keys("Hriodoy")
time.sleep(3)

password_field1 = driver.find_element(By.CLASS_NAME, "age")
password_field1.click()
password_field1.send_keys("23")
time.sleep(3)

number_field2 = driver.find_element(By.CLASS_NAME, "emppass")
number_field2.click()
number_field2.send_keys("333")

number_field3 = driver.find_element(By.CLASS_NAME, "emprepass")
number_field3.click()
